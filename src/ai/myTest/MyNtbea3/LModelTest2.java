...
*/
	...
	private static void testing_addToModel(LModel lmodel, boolean print) {
		...
		current[0] = new DropAction(Card.KNIGHT, new Position(0,0)); 
		current[1] = new UnitAction(new Position(0,0), new Position(0,2) , UnitActionType.MOVE); 
		current[2] = new DropAction(Card.KNIGHT, new Position(5,0));  
		current[3] = new UnitAction(new Position(5,0), new Position(5,2) , UnitActionType.MOVE); 
		current[4] = new UnitAction(new Position(0,2), new Position(0,4) , UnitActionType.MOVE);
		double val = 5;
...
class Objeto2{
	...
	public List<Objeto2> possibleActions() {
		List<Objeto2> devolver = new LinkedList<Objeto>();
		devolver.add(new Objeto2("Z"));
		devolver.add(new Objeto2("A"));
		devolver.add(new Objeto2("B"));
		devolver.add(new Objeto2("C"));
		devolver.add(new Objeto2("D"));
		devolver.add(new Objeto2("E"));
		devolver.add(new Objeto2("F"));
		return devolver;
	}
